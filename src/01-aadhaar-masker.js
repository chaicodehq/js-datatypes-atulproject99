...
export function maskAadhaar(aadhaarNumber) {
  ...
  if (typeof aadhaarNumber !== 'string' || aadhaarNumber.length != 12 || aadhaarNumber.includes(' ') || aadhaarNumber.includes('-') || !/^\d+$/.test(aadhaarNumber)) return "INVALID";
  const masked =
    "X".repeat(8) + aadhaarNumber.slice(8);
